...
public:
	...
	*/
	...
	/** @brief getVector()
	@return vector de mutaciones
	*/
	vector<mutacion> getVector() const;
	...
	*/
	...
	pair<conjunto::value_type,bool>  find2 (const string & chr) const;
	...
	*/
	...
	conjunto::iterator lower_bound2 (const string & chr);
...
private:
	...
	std::vector<mutacion> vm; // vector que almacena los elementos del conjunto
